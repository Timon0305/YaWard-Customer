...
class MyCart extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            vatFee: 50,
            cartTotalPrice: '',
            cartProduct: JSON.parse(sessionStorage.getItem('cartItems')) ? JSON.parse(sessionStorage.getItem('cartItems')) : [],
    ...
    render () {
        ...
        return (
            <React.Fragment>
                <Card>
                    <div color='primary' className="btn btn-primary font-size-18 text-center borderRadius">{this.props.t('Your')} {this.props.t('Order')}</div>
...
export default withNamespaces()(MyCart)